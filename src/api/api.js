...
export const getDataCount = () => {
	return axios.get(`/api/admin/back_home/data_count`).then(res => res.data);
};
export const getChartVisits = () => {
	return axios.get(`/api/admin/back_home/chart_visits`).then(res => res.data);
};
export const getChartComments = () => {
	return axios.get(`/api/admin/back_home/chart_comments`).then(res => res.data);
};
...
export const delArticle = params => {
	return axios.delete(`/api/admin/article_mgt/del`, params).then(res => res.data);
};
...
export const delComment = params => {
	return axios.delete(`/api/admin/comment_mgt/del`, params).then(res => res.data);
};
...
export const getSubCategories = params => {
	return axios.get(`/api/admin/sub_categories/list`, params).then(res => res.data);
};
export const moveArticles = params => {
	return axios.post(`/api/admin/sub_categories/move`, params).then(res => res.data);
};
export const delArticles = params => {
	return axios.delete(`/api/admin/sub_categories/del`, params).then(res => res.data);
};
...
export const submitMessageBoard = (params) => {
	return axios.post(`/api/front/submit_message_board`, params).then(res => res.data);
};
export const sendEmail = (params) => {
	return axios.post(`/api/front/send_email`, params).then(res => res.data);
};
