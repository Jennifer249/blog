...
CREATE TABLE `article` (
  ...
  `article_visits` int DEFAULT NULL,
  `article_comments` int DEFAULT NULL,
...
INSERT INTO `blog_images` VALUES (204,'upload\\hTZ7vJovhOnG9C0yMax7Llmu.png',-1),(205,'upload\\3xQ3-rogpmABjf49UXYSXhEo.png',-1),(206,'upload\\r0_6FVu8qysTbyyfLNpd6YtZvW.png',-1),(207,'upload\\0_QipDc2tCBff6TLStuiVAppZ.png',-1),(215,'upload\\xrujJJdyJ1ScjmarhzGXylpx.png',216),(216,'upload\\mlgDBgeBBABN065S5Qqgtru0.png',216),(217,'upload\\aA06MJKYEWudPsi72PMvFaB0.png',216),(218,'upload\\EjuIadpSJHZuTPIMQZnCp4C_.png',217),(219,'upload\\TjFm9pAs960wU8Wv5MIWwVTv.png',217),(220,'upload\\ACZgFJLplm2TbFJRAl5tgPDQ.png',217),(224,'upload\\S8tmT6yjohDUOFGgRY0GSzBQ.png',219),(225,'upload\\kwFOpEV01JCObEg5TJLJewM5.png',219),(226,'upload\\PXkC5vGyI_TEe9UzOE_Qi6Nx.png',219),(235,'upload\\B6oW7FOY1dpY2YFk8Om7y67P.png',222),(236,'upload\\P9W3mRjc9IB-fovuf5cnrUkA.png',222),(237,'upload\\TGA5Cr6of9NkUBJFXv8r3-5m.png',-1),(238,'upload\\rLwyafGD0lVZKAK_t0zwBAia.png',-1),(239,'upload\\HtsfQ4movuPIkJZTiBzS63ui.png',-1),(240,'upload\\-BWe8aMIg5_pHbEJOxN6tTWk.png',223),(241,'upload\\PVOroJ00lj6Na4A7rT70bdS3.png',223),(242,'upload\\2GUKOwZMw2LGwMP1HiQCFWSJ.png',223),(243,'upload\\wget6olDs41P-BJyKalJz6-8.png',223),(244,'upload\\wG7hvwuvRxRFdoU7tZHKdf-N.png',226),(247,'upload\\RzbEwtsJOSuZc9cceZUf23Iw.png',228),(248,'upload\\237J-7nPgyDeBtKxLIE-Sut4.png',228),(249,'upload\\IduRXzR0q9YqLg97hplp0BqV.png',228),(250,'upload\\gR7mZhOtSolUO2dukYoXVBWw.png',228),(251,'upload\\d9k4BlExU-FAKyirm6h60zf4.png',229),(252,'upload\\UdsQzCioQxTKe1koxRspkNxP.png',229),(253,'upload\\SnHzT2qPAvBBffivkvCICa2y.png',229),(254,'upload\\sXc_P3VxeLusraIpOwsNs_OM.png',229),(255,'upload\\kaIQvCSG-S0gZ9NAS4C0xa8I.png',229),(256,'upload\\4zc5Y2lRoY8i2HJrU2xfIdEk.png',235);
...
INSERT INTO `comment` VALUES (109,233,99,'look look','2020-07-11 10:37:47',1,0),(110,233,1,'hi','2020-07-11 11:18:17',99,109),(111,233,100,'xixi','2020-07-11 11:22:18',1,110),(112,233,101,'你好','2020-07-11 13:12:45',99,109),(113,233,102,'zai','2020-07-11 13:14:51',1,0);
...
CREATE TABLE `comments_records` (
  `comments_record_id` int NOT NULL AUTO_INCREMENT,
  `comments_date` date DEFAULT NULL,
  `comments_day_count` int DEFAULT NULL,
...
CREATE TABLE `session_user_state` (
  ...
  `session_cookie_id` int DEFAULT NULL,
...
CREATE TABLE `statistics_data` (
  `article_sum` int DEFAULT NULL,
  `comment_sum` int DEFAULT NULL,
  `visit_sum` int DEFAULT NULL,
  `categories_sum` int DEFAULT NULL,
  `tag_sum` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_info` VALUES (1,'jennifer','7ac7893de2fdf1d004626fa3562406696c07747e','../img/user.jpg','Pratice more','say something','249542247@qq.com','陈卓林 | 个人博客',_binary 'czl_blog');
...
CREATE TABLE `visits_records` (
  `visits_record_id` int NOT NULL AUTO_INCREMENT,
  `visits_date` date DEFAULT NULL,
  `visits_day_count` int DEFAULT NULL,
...
-- Dump completed on 2020-07-11 15:12:50
