var sqlMap = {
	...
	stat: {
		...
		getArticleSum: 'SELECT COUNT(*) AS article_sum FROM article'
	},
	commentsRecords: {
	...
	article: {
		...
		getStateArticle: 'SELECT * FROM article WHERE article_state regexp ? ORDER BY article_time DESC LIMIT ?, ?',
		getArticle: 'SELECT * FROM article WHERE article_id = ?',
		getSearchResult: "SELECT * FROM article WHERE article_time regexp ? and categories_id regexp ? and article_title regexp ?",
		getPreId: 'SELECT article_id, article_title FROM article WHERE article_id < ? ORDER BY article_id DESC LIMIT 1',
		getNextId: 'SELECT article_id, article_title FROM article WHERE article_id > ? ORDER BY article_id LIMIT 1'
	},
	categories: {
