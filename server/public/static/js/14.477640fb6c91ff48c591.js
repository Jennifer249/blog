          ...
          [
            _vm._l(_vm.articleList, function(item, index) {
              return _c("li", [
                ...
                _vm._v(" "),
                _c("label", { attrs: { for: "awesome" + index } }, [
    ...
    getSubCategoriesInfo: function getSubCategoriesInfo() {
      ...
      Object(api["s" /* getSubCategories */])({
        ...
        if (res.state === 0 || res.state === 1) {
          ...
          _this.articleList = res.data.subCategoriesList;
        }
      });
    },
...
var sub_categories_mgtvue_type_style_index_0_id_ea8f08b2_scoped_true_lang_css_ = __webpack_require__(511);
...
//# sourceMappingURL=14.477640fb6c91ff48c591.js.map